...
## Segunda terminal - Accounting:

Iniciar el contenedor, crear la base de datos y conectarse a PostgreSQL.
...
### Trigger para probar errores
Hacer que falle cuando el importe tenga 99 centavos.
...
```
## Segunda terminal - Sales
Crear la base de datos y conectarse para crear la tabla.
